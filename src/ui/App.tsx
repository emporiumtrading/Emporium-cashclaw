...
import { Bids } from "./pages/Bids.js";
...
type Page = "dashboard" | "tasks" | "bids" | "products" | "predictions" | "chat" | "settings";
...
const NAV: { page: Page; label: string; icon: string }[] = [
  ...
  { page: "bids", label: "Bids", icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
  { page: "products", label: "Products", icon: "M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" },
  { page: "predictions", label: "Predictions", icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" },
