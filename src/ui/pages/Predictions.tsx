        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-zinc-500 mt-0.5">
              Max 10% per trade &middot; Max 50% total exposure &middot; 80% min confidence &middot; $3 daily loss limit &middot; Max 5 positions
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="card p-4 sticky top-8">
          ...
          <div className="mt-3 pt-3 border-t border-zinc-800/50">
            ...
            <p className="text-[10px] text-zinc-700 mt-0.5">
              80% min confidence &middot; 10% max per trade &middot; Quick in/out daily
            </p>
          </div>
        </div>
      </div>
